...
## Project Structure
    ...
    ├── cliffordspottery_32759  # Django project configurations
...
1. Clone this repo and `cd cliffordspottery_32759`
...
2. Clone this repo and `cd cliffordspottery_32759`
